...
const SubcategoryServices = () => {
  ...
  const subcategoryPath = category && subcategory ? `/services/${category}/${subcategory}` : '';
  ...
  // Map subcategory path to a display name
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        {loading ? (
          ...
          <div className="text-center py-10">
            <p className="text-gray-500">No services found for {displayName}.</p>
          </div>
        ) : (
